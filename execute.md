...
echo "==========================="
echo "CRITICAL: Perform comprehensive codebase analysis before implementing:"
echo ""
echo "🔍 CODEBASE CONTEXT DISCOVERY (Required)"
echo "- Analyze the codebase to understand: programming language, framework, architecture patterns"
echo "- Identify existing file organization, naming conventions, and code patterns"
echo "- Discover authentication, validation, error handling, and testing patterns already in use"
echo "- Understand database type, ORM patterns, and data access layers"
echo "- Review build tools, package managers, and deployment configurations"
echo "- Examine API patterns (REST/GraphQL), dependency injection, and integration points"
echo ""
...
echo "- MUST align implementation with discovered codebase patterns and conventions"
echo ""
